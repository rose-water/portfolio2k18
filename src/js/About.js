    ...
    return (
      <div>
        ...
        <div id="about" className="inner-page-container">
          ...
          <p>I create speculative interventions as a form of critique and way to reimagine systems at various scales, which often take shape through the design and development of fictional artifacts, objects, and interfaces. My design and research methods foreground making and experimentation; I frequently work with various 2D + 3D software tools, mixed-media illustration, and physical computing.</p>
