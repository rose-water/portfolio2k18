module.exports = [
  {
    ...
    "projects" : [
...

      {
        ...
        "years": "2020",
        "collaborators": "",
        "description": "A system design for a reimagined seed vault, where the organization, storage, and movement of seeds is facilitated by robot agents that deliver seeds based on need. Here, I imagine a plausible scenario where natural seed dispersal mechanisms are eradicated or at-risk as a result of climate change. <br /><br />Course: <br/><i>Grad Design Studio II<br/>Media Design Practices</i>",
        "content": "Coming Soon.",
        "videoEmbedUrl" : ``,
        "imgs": [],
    ...
    
      {
        ...
        "description": "An interactive installation that generates digital shadows of participants, displaying personal information about them retrieved from internet databases with the use of just their email addresses. <br/><br/>Exhibited at:<br/><i>\"Manual Override\"</i> at The Shed<br/><i>\"Uncanny Valley\"</i> at de Young Museum",
        "content": "Coming Soon.",
        "videoEmbedUrl" : ``,
        "imgs": [],
        "tools": ["ReactJS", "d3.js", "Node.js", "Julia"],
