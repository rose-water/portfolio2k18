module.exports = [
  {
    ...
    "projects" : [
      ...
      
      {
        ...
        "content": "Cepheids, also known as Cepheid Variables, \"are a type of star that pulsates radially, varying in both diameter and temperature.\" (from Wikipedia).<br/><br/>This project was created as part of \"Creative Programming for Digital Media & Mobile Apps\" on Coursera.<br/><br/><sub><sup>*</sup><i>This video plays audio.</i></sub>",
      ...
      
      {
        ...
        "content": "VidCoach is the result of a year-long effort to research and build tools for individuals with Autism Spectrum Disorder (ASD), focusing on adolescents participating in school-to-work transition programs (students making the transition to adulthood, from high school into the workforce), which is a subset of the ASD population often overlooked in research. <br/><br/>Using ethnographic methods as my primary mode of inquiry, I observed at workshops teaching students ‘tech etiquette’ (e.g., not answering the phone during work hours) as well as how to use smartphone apps (e.g., how to use a calendar app to schedule work shifts and job interviews). I went into the field and spoke with professional caretakers to understand their students’ primary needs, and involved them throughout the research and design processes to ensure that these needs were being fulfilled.<br/><br/>I also spoke with management at several companies in the surrounding area to ask for volunteers who would be willing to conduct mock interviews with the students and evaluate their performances.<br/><br/>These conversations and observations informed the design of an iOS app called ‘VidCoach,’ an app designed to aid students in learning and retaining valuable life skills. The first release of the app was aimed at teaching students how to interview for jobs.",
        "publications" : [
